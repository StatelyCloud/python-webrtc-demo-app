...
class Participant(_message.Message):
    __slots__ = ("username", "room", "joined", "session_id")
    ...
    joined: int
    session_id: bytes
    def __init__(self, username: _Optional[str] = ..., room: _Optional[str] = ..., joined: _Optional[int] = ..., session_id: _Optional[bytes] = ...) -> None: ...

class SignalingMessage(_message.Message):
    __slots__ = ("message_id", "message_type", "room", "created_at", "payload_json")
    ...
    created_at: int
    payload_json: str
    def __init__(self, message_id: _Optional[int] = ..., message_type: _Optional[_Union[SignalingMessageType, str]] = ..., room: _Optional[str] = ..., created_at: _Optional[int] = ..., payload_json: _Optional[str] = ...) -> None: ...
